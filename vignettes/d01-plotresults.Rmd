...
Per the scope of this study, only the COAD and READ data were further analyzed. The number of samples with each allele were counted. Finally, the rare negative numbers were set to 0.
